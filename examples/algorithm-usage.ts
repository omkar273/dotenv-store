/**
 * Example demonstrating how to use env-store with different encryption algorithms
 */
...
async function algorithmExample() {
    ...
    console.log('npx env-store decrypt --algorithm aes-256-cbc --key my-secret-key');

    console.log('\n# Initialize with TripleDES:');
    console.log('npx env-store init --algorithm tripledes');
